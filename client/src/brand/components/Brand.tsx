...
const Brand = () => {
    ...
    if (isError || !brand) {
        return <div className="p-10 text-red-500 font-semibold">Brand not found!</div>;
    }
...
const AdditionalInformation = ({ brandData }: BrandDataProps) => {
    return (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm font-bold text-slate-800 dark:text-slate-200 mt-0.5">
                            {brandData.createdAt ? format(new Date(brandData.createdAt), "dd-MM-yyyy") : "N/A"}
                        </p>
                    </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm font-bold text-slate-800 dark:text-slate-200 mt-0.5">
                            {brandData.updatedAt ? format(new Date(brandData.updatedAt), "dd-MM-yyyy") : "N/A"}
                        </p>
                    </div>
                </div>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-bold text-red-700 dark:text-rose-300 mt-0.5">
                                {format(new Date(brandData.deletedAt), "dd-MM-yyyy")}
                            </p>
                        </div>
                    </div>
                )}
